...
const categoryItineraries: Record<string, any[]> = {
  'beach-paradise': [
    {
      id: 1,
...
const categoryDetails: Record<string, { name: string; description: string; icon: string; color: string }> = {
  'beach-paradise': {
    name: 'Beach Paradise',
...
// Export data for client component
export { categoryItineraries, categoryDetails };
