import { ThreadSuggestion, RuntimeCapabilities, ThreadRuntimeCore, SpeechState, ThreadRuntimeEventType, StartRunConfig, ResumeRunConfig } from "../runtime-cores/core/ThreadRuntimeCore";
...
export declare class ThreadRuntimeImpl implements ThreadRuntime {
    ...
    get __internal_threadBinding(): import("./subscribable/Subscribable").Subscribable & {
        ...
        getState: () => Readonly<{
            ...
            stopSpeaking: () => void;
            getSubmittedFeedback: (messageId: string) => import("../runtime-cores/core/ThreadRuntimeCore").SubmittedFeedback | undefined;
